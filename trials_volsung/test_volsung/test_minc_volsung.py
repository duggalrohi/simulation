...
model = []
elements = []
model_ = VolsungModel(r"C:\Users\rohit\Downloads\test_volsung\Results.sigurd", brynhild_fname = r"C:\Users\rohit\Downloads\test_volsung\test_minc.brynhild")     # note: need to explicitly provide brynhild_fname since T2Fafnir does not store xml in results.
