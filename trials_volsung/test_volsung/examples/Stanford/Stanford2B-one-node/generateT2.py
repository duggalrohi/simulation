...
Create a TOUGH2 model of Stanford Test Problem #2B - one node
...
data.parameter['tstop'] = data.parameter['tstart'] + 60*60*24 * 0.01
data.parameter['const_timestep'] = 9
data.parameter['max_timestep'] = 9
...
# set the print times
data.output_times['time'] = np.arange(0,864,9).tolist()
