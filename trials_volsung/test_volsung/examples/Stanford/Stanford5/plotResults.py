...
model = VolsungModel("Brynhild/Results.sigurd", brynhild_fname = "Brynhild/Stanford5.brynhild")     # note: need to explicitly provide brynhild_fname since T2Fafnir does not store xml in results.
...
# find the cell in brynhild output which contains the ' aa 1' element in TOUGH2
t2name = ' aa 1'
t2sourcename = 'src 1'
cid = model.reservoir.cellId((6.250e+01,6.250e+01,-5.000e+01))
