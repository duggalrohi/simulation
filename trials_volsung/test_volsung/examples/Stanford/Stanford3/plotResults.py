...
model = VolsungModel("Brynhild/Results.sigurd", brynhild_fname = "Brynhild/Stanford3.brynhild")     # note: need to explicitly provide brynhild_fname since T2Fafnir does not store xml in results.
...
# find the cell in brynhild output which contains the '  a10' element in TOUGH2
t2name = '  a10'
t2sourcename = 'src 1'
cid = model.reservoir.cellId((8.000e-02,1.000e+01,-9.500e-01))
